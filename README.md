...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-24 13:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/16dc6708-6c66-4adc-ac2c-dd784f91a17a.git
$ cd 16dc6708-6c66-4adc-ac2c-dd784f91a17a
```
